...
In this late game position, we are down 383-428 and the bag has just 14 tiles in it. The static evaluator prefers the play `13A BONED`, making ODE and FED vertically. This isn't a great play; it blocks a weak bingo lane making LOOF/yOOF, and it leaves the Q on our rack without a good place to put it. Our opponent's next play will likely involve playing in the bottom right quadrant, trying to mess up the WAGE hook and shutting down the board. We're often not in a good position to win this game after BONED, despite its high score.
